...
Evaluation counterpart of imagenet/train.py: one pass over the validation split,
reporting top-1/top-5 and the nonzero activation counts behind the operation
figures. Pass --fusion to pick the residual operator; it must match the operator
...
parser.add_argument('-data-dir', '--data-dir', metavar='DIR',
                    default='', help='path to the dataset root (required; set it here or in the config file)')
